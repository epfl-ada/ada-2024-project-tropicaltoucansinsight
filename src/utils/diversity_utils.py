...
def plot_word_frequency(df, column, title="Word Frequency Visualization", filename="word_frequency.pdf", ax=None):
    """
...
def calculate_diversity_with_glove(df, embeddings):
    ...
    for name in cluster_names:
        ...
        if token_embeddings:
            ...
            # Skip cluster names with no embeddings
            print(f"Warning: No embeddings found for cluster name: '{name}'")
...
def plot_diversity_histogram(diversities, filename=None, show_means=True):
    """
